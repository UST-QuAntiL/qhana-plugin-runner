...
def _registers(name: str, version: str) -> bool:
    ...
    plugin registry is restored afterwards to keep the mock invisible to
    other tests.
    """
    ...
    mock = type("_MockPlugin", (QHAnaPluginBase,), {"name": name, "version": version})
    accepted = hasattr(mock, "instance")
