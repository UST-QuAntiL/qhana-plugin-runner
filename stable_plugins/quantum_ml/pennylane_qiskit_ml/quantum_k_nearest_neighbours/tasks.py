...
def calculation_task(self, db_id: int) -> str:
    ...
    # Label test data
    predictions = [int_to_label[el] for el in qknn.label_points(test_data)]
    ...
    info_str = f"_qknn_variant_{variant.name}_neighbours_{neighbourhood_size}_{filename_hash}"
