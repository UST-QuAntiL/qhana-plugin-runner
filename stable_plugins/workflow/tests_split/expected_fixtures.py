...
EXPECTED = {
    ...
    "tc60_data_analysis_pipeline.bpmn": {
        "main_nodes": [
            ("startEvent", "StartEvent_1"),
            ("adHocSubProcess[wrapper=E1]", "AdHoc_E1_Wrapper"),
            ("adHocSubProcess[original]", "AdHoc_Analysis"),
            ("exclusiveGateway", "Gateway_XOR_Split"),
            ("adHocSubProcess[wrapper=E2]", "AdHoc_E2_Wrapper"),
            ("adHocSubProcess[wrapper=E3]", "AdHoc_E3_Wrapper"),
            ("exclusiveGateway", "Gateway_XOR_Merge"),
            ("endEvent", "EndEvent_1"),
        ],
        "main_flows": [
            ("Flow_Start_to_DataCreator", "StartEvent_1", "AdHoc_E1_Wrapper", None),
            ("Flow_OneHot_to_AdHoc", "AdHoc_E1_Wrapper", "AdHoc_Analysis", None),
            ("Flow_AdHoc_to_XOR", "AdHoc_Analysis", "Gateway_XOR_Split", None),
            (
                "Flow_XOR_to_KMeans",
                "Gateway_XOR_Split",
                "AdHoc_E2_Wrapper",
                '${start_datasetType == "clustered"}',
            ),
            ("Flow_XOR_to_SVM", "Gateway_XOR_Split", "AdHoc_E3_Wrapper", None),
            ("Flow_KMeans_to_Merge", "AdHoc_E2_Wrapper", "Gateway_XOR_Merge", None),
            ("Flow_SVM_to_Merge", "AdHoc_E3_Wrapper", "Gateway_XOR_Merge", None),
            ("Flow_Merge_to_End", "Gateway_XOR_Merge", "EndEvent_1", None),
        ],
        "fragments": [
            {
                "fragment_id": "E1",
                ...
                "flow_ids": [
                    "Flow_E1_start",
                    "Flow_DataCreator_to_OneHot",
                    "Flow_E1_end",
                ],
            },
            {
                "fragment_id": "E2",
                "process_id": "DataAnalysisPipeline_E2",
                "wrapper_id": "AdHoc_E2_Wrapper",
                "inputs": ["qoutput.encodedData"],
                "outputs": [],
                "task_ids": ["Task_KMeans"],
                "flow_ids": ["Flow_E2_start", "Flow_E2_end"],
            },
            {
                "fragment_id": "E3",
                "process_id": "DataAnalysisPipeline_E3",
                "wrapper_id": "AdHoc_E3_Wrapper",
                "inputs": ["qoutput.encodedData"],
                "outputs": [],
                "task_ids": ["Task_SVM"],
