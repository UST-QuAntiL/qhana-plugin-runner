EXPECTED = {'tc01_exec_before_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
 ...
 'tc02_exec_after_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                               ('adHocSubProcess[original]', 'AdHocSubProcess_1'),
                                               ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                               ('endEvent', 'EndEvent_1')],
                                'main_flows': [('Flow_1', 'StartEvent_1', 'AdHocSubProcess_1', None),
 ...
 'tc03_exec_before_and_after_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                          ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                          ('adHocSubProcess[original]', 'AdHocSubProcess_1'),
 ...
 'tc04_only_exec_no_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                 ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                 ('endEvent', 'EndEvent_1')],
                                  'main_flows': [('Flow_1', 'StartEvent_1', 'AdHoc_E1_Wrapper', None),
                                  ...
                                  'fragments': [{'fragment_id': 'E1',
                                                 ...
                                                 'flow_ids': ['Flow_E1_start',
                                                              ...
                                                              'Flow_5',
                                                              'Flow_E1_end']}]},
 'tc05_only_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                         ('adHocSubProcess[original]', 'AdHocSubProcess_1'),
                                         ('endEvent', 'EndEvent_1')],
                          'main_flows': [('Flow_1', 'StartEvent_1', 'AdHocSubProcess_1', None),
                                         ('Flow_2', 'AdHocSubProcess_1', 'EndEvent_1', None)],
                          'fragments': []},
 'tc06_multiple_adhoc_blocks.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                    ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                    ('adHocSubProcess[original]', 'AdHocSubProcess_1'),
                                                    ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
 ...
 'tc07_xor_exec_vs_exec.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                               ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                ...
                                'fragments': [{'fragment_id': 'E1',
                                              ...
                                              {'fragment_id': 'E3',
                                               ...
                                               'flow_ids': ['Flow_E3_start', 'Flow_E3_end']}]},
 'tc08_xor_exec_vs_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                ('exclusiveGateway', 'Gateway_Split'),
                                                ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                 ...
                                 'fragments': [{'fragment_id': 'E1',
                                               ...
                                               {'fragment_id': 'E2',
                                                ...
                                                'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc09_xor_adhoc_vs_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                 ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                 ('exclusiveGateway', 'Gateway_Split'),
                                  ...
                                  'fragments': [{'fragment_id': 'E1',
                                                 ...
                                                 'task_ids': ['UserTask_Input'],
                                                 'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc10_xor_exec_before_merge_then_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                               ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                               ('exclusiveGateway', 'Gateway_Split'),
                                                               ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                                               ('adHocSubProcess[wrapper=E3]', 'AdHoc_E3_Wrapper'),
                                                ...
                                                'fragments': [{'fragment_id': 'E1',
                                                              ...
                                                              {'fragment_id': 'E3',
                                                               ...
                                                               'flow_ids': ['Flow_E3_start', 'Flow_E3_end']}]},
 'tc11_xor_adhoc_inside_branch.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                      ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                      ('exclusiveGateway', 'Gateway_Split'),
                                                      ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                                      ('adHocSubProcess[original]', 'AdHocSubProcess_Manual'),
 ...
 'tc12_xor_default_flow_preservation.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                            ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                            ('exclusiveGateway', 'Gateway_Split'),
                                                            ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                             ...
                                             'fragments': [{'fragment_id': 'E1',
                                                           ...
                                                           {'fragment_id': 'E2',
                                                            ...
                                                            'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc13_and_exec_parallel.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                 ...
                                 'fragments': [{'fragment_id': 'E1',
                                               ...
                                               {'fragment_id': 'E3',
                                                ...
                                                'flow_ids': ['Flow_E3_start', 'Flow_E3_end']}]},
 'tc14_and_exec_vs_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                ('parallelGateway', 'Gateway_Split'),
                                                ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                 ...
                                 'fragments': [{'fragment_id': 'E1',
                                               ...
                                               {'fragment_id': 'E2',
                                                ...
                                                'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc15_and_both_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                             ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                             ('parallelGateway', 'Gateway_Split'),
                              ...
                              'fragments': [{'fragment_id': 'E1',
                                             ...
                                             'task_ids': ['UserTask_Input'],
                                             'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc16_and_join_after_extraction.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                        ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                        ('parallelGateway', 'Gateway_Split'),
                                                        ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                         ...
                                         'fragments': [{'fragment_id': 'E1',
                                                       ...
                                                       {'fragment_id': 'E3',
                                                        ...
                                                        'flow_ids': ['Flow_E3_start', 'Flow_E3_end']}]},
 'tc17_and_duplicate_edge_case.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                      ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                      ('parallelGateway', 'Gateway_Split'),
                                                      ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                                      ('adHocSubProcess[wrapper=E3]', 'AdHoc_E3_Wrapper'),
                                       ...
                                       'fragments': [{'fragment_id': 'E1',
                                                     ...
                                                     {'fragment_id': 'E3',
                                                      ...
                                                      'flow_ids': ['Flow_E3_start', 'Flow_E3_end']}]},
 'tc18_adhoc_at_start.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                             ('adHocSubProcess[original]', 'AdHocSubProcess_Init'),
                                             ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                             ('endEvent', 'EndEvent_1')],
                              'main_flows': [('Flow_1', 'StartEvent_1', 'AdHocSubProcess_Init', None),
                              ...
                              'fragments': [{'fragment_id': 'E1',
                                             ...
                                             'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc19_adhoc_at_end.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                           ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                            ...
                            'fragments': [{'fragment_id': 'E1',
                                           ...
                                           'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_E1_end']}]},
 'tc20_nested_adhoc.bpmn': {'nsup': "Nested ad-hoc subprocess not supported (outer id='AdHocSubProcess_Outer', inner "
                                    "id='AdHocSubProcess_Inner')."},
 'tc21_adhoc_with_non_qhana_task.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                        ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                         ...
                                         'fragments': [{'fragment_id': 'E1',
                                                        ...
                                                        'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_E1_end']}]},
 'tc22_multiple_exec_segments_around_adhoc.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                                  ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                                  ('adHocSubProcess[original]',
                                                                   'AdHocSubProcess_Review1'),
                                                                  ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                                                  ('adHocSubProcess[original]',
                                                                   'AdHocSubProcess_Review2'),
                                                                  ('adHocSubProcess[wrapper=E3]', 'AdHoc_E3_Wrapper'),
                                                                  ('endEvent', 'EndEvent_1')],
                                                   'main_flows': [('Flow_1', 'StartEvent_1', 'AdHoc_E1_Wrapper', None),
                                                                  ('Flow_3',
                                                   ...
                                                   'fragments': [{'fragment_id': 'E1',
                                                                 ...
                                                                 {'fragment_id': 'E3',
                                                                  ...
                                                                  'flow_ids': ['Flow_E3_start', 'Flow_E3_end']}]},
 'tc23_mixed_task_types_exec_chain.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                          ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                           ...
                                           'fragments': [{'fragment_id': 'E1',
                                                         ...
                                                         {'fragment_id': 'E2',
                                                          ...
                                                          'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc24_non_convertible_tasks.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                    ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                     ...
                                     'fragments': [{'fragment_id': 'E1',
                                                   ...
                                                   {'fragment_id': 'E2',
                                                    ...
                                                    'task_ids': ['QHanaTask_Finalize'],
                                                    'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc25_single_user_task.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                               ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                               ('endEvent', 'EndEvent_1')],
                                'main_flows': [('Flow_1', 'StartEvent_1', 'AdHoc_E1_Wrapper', None),
                                               ('Flow_4', 'AdHoc_E1_Wrapper', 'EndEvent_1', None)],
                                'fragments': [{'fragment_id': 'E1',
                                               ...
                                               'inputs': [],
                                               'outputs': [],
                                               'task_ids': ['UserTask_SelectOption',
                                                            'QHanaTask_RunSelection',
                                                            'QHanaTask_SaveSelection'],
                                               'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_3', 'Flow_E1_end']}]},
 'tc26_variable_exec_to_main.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                    ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                     ...
                                     'fragments': [{'fragment_id': 'E1',
                                                    ...
                                                    'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_E1_end']}]},
 'tc27_variable_main_to_exec.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                    ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                     ...
                                     'fragments': [{'fragment_id': 'E1',
                                                   ...
                                                   {'fragment_id': 'E2',
                                                    ...
                                                    'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc28_data_object_cross_boundary.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                         ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                         ('adHocSubProcess[original]', 'AdHocSubProcess_Review'),
                                                         ('endEvent', 'EndEvent_1'),
                                          ...
                                          'fragments': [{'fragment_id': 'E1',
                                                         ...
                                                         'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_E1_end']}]},
 'tc29_association_cleanup.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                  ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                  ('adHocSubProcess[original]', 'AdHocSubProcess_Audit'),
                                                  ('endEvent', 'EndEvent_1'),
                                   ...
                                   'fragments': [{'fragment_id': 'E1',
                                                  ...
                                                  'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_E1_end']}]},
 'tc30_send_task.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                        ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                         ...
                         'fragments': [{'fragment_id': 'E1',
                                       ...
                                       {'fragment_id': 'E2',
                                        ...
                                        'task_ids': ['QHanaTask_Finalize'],
                                        'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc31_receive_task.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                           ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                            ...
                            'fragments': [{'fragment_id': 'E1',
                                          ...
                                          {'fragment_id': 'E2',
                                           ...
                                           'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc32_message_inside_exec_vs_main.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                          ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                          ('adHocSubProcess[original]', 'AdHocSubProcess_1'),
                                           ...
                                           'fragments': [{'fragment_id': 'E1',
                                                         ...
                                                         {'fragment_id': 'E2',
                                                          ...
                                                          'task_ids': ['QHanaTask_Finalize'],
                                                          'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc33_pool_lane_preservation.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                     ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                     ('adHocSubProcess[original]', 'AdHocSubProcess_Review'),
                                                     ('endEvent', 'EndEvent_1')],
                                      'main_flows': [('Flow_1', 'StartEvent_1', 'AdHoc_E1_Wrapper', None),
                                      ...
                                      'fragments': [{'fragment_id': 'E1',
                                                     ...
                                                     'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc34_lane_partial_removal.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                   ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                    ...
                                    'fragments': [{'fragment_id': 'E1',
                                                  ...
                                                  {'fragment_id': 'E2',
                                                   ...
                                                   'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc35_multiple_pools.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                             ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                              ...
                              'fragments': [{'fragment_id': 'E1',
                                             ...
                                             'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc36_di_cleanup.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                         ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                         ('adHocSubProcess[original]', 'AdHocSubProcess_1'),
                                         ('adHocSubProcess[wrapper=E2]', 'AdHoc_E2_Wrapper'),
                                         ('endEvent', 'EndEvent_1'),
                          ...
                          'fragments': [{'fragment_id': 'E1',
                                        ...
                                        {'fragment_id': 'E2',
                                         ...
                                         'task_ids': ['QHanaTask_Finalize'],
                                         'flow_ids': ['Flow_E2_start', 'Flow_E2_end']}]},
 'tc37_extension_preservation.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                     ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                      ...
                                      'fragments': [{'fragment_id': 'E1',
                                                     ...
                                                     'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc38_custom_attributes.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                ('endEvent', 'EndEvent_1')],
                                 'main_flows': [('Flow_1', 'StartEvent_1', 'AdHoc_E1_Wrapper', None),
                                                ('Flow_3', 'AdHoc_E1_Wrapper', 'EndEvent_1', None)],
                                 'fragments': [{'fragment_id': 'E1',
                                                ...
                                                'flow_ids': ['Flow_E1_start', 'Flow_2', 'Flow_E1_end']}]},
 'tc39_compressed_flow_condition.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                        ('exclusiveGateway', 'Gateway_Split'),
                                                        ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                        ('adHocSubProcess[original]', 'AdHocSubProcess_Manual'),
                                                        ('exclusiveGateway', 'Gateway_Merge'),
                                                        ('endEvent', 'EndEvent_1')],
                                         'main_flows': [('Flow_Cond',
                                                         'Gateway_Split',
                                                         'AdHoc_E1_Wrapper',
                                                         '${urgent == true}'),
 ...
 'tc40_default_flow_remap.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                 ('exclusiveGateway', 'Gateway_Split'),
                                                 ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                 ('adHocSubProcess[original]', 'AdHocSubProcess_Manual'),
                                                 ('endEvent', 'EndEvent_1')],
                                  'main_flows': [('Flow_1', 'StartEvent_1', 'Gateway_Split', None),
                                  ...
                                  'fragments': [{'fragment_id': 'E1',
                                                 ...
                                                 'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc41_multiple_flows_same_src_target.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                             ('exclusiveGateway', 'Gateway_Split'),
                                                             ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                             ('endEvent', 'EndEvent_1')],
                                              'main_flows': [('Flow_1', 'StartEvent_1', 'Gateway_Split', None),
                                              ...
                                              'fragments': [{'fragment_id': 'E1',
                                                             ...
                                                             'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc42_no_dangling_nodes.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('exclusiveGateway', 'Gateway_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                ('adHocSubProcess[original]', 'AdHoc_1'),
                                                ('exclusiveGateway', 'Gateway_2'),
                                                ('endEvent', 'EndEvent_1')],
                                 'main_flows': [('Flow_1', 'StartEvent_1', 'Gateway_1', None),
                                 ...
                                 'fragments': [{'fragment_id': 'E1',
                                                ...
                                                'task_ids': ['Task_Exec'],
                                                'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc43_start_to_end_path.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('adHocSubProcess[original]', 'AdHoc_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                ('adHocSubProcess[original]', 'AdHoc_2'),
                                                ('endEvent', 'EndEvent_1')],
                                 'main_flows': [('Flow_1', 'StartEvent_1', 'AdHoc_1', None),
                                 ...
                                 'fragments': [{'fragment_id': 'E1',
                                                ...
                                                'task_ids': ['Task_Exec'],
                                                'flow_ids': ['Flow_E1_start', 'Flow_E1_end']}]},
 'tc44_no_orphan_elements.bpmn': {'nsup': "Unsupported Phase 2/3 element 'boundaryEvent' (id='BoundaryEvent_1')."},
 'tc45_wu_palmer_partial.bpmn': {'main_nodes': [('startEvent', 'StartEvent_1'),
                                                ('adHocSubProcess[wrapper=E1]', 'AdHoc_E1_Wrapper'),
                                                ('adHocSubProcess[original]', 'Activity_AdHocCluster'),
                                                ('endEvent', 'Event_0ck8ig8')],
                                 'main_flows': [('Flow_05mvkgh', 'StartEvent_1', 'AdHoc_E1_Wrapper', None),
