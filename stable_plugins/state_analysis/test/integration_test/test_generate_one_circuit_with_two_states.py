...
def test_generate_one_circuit_with_two_states(case, file_maker_client):
    """
    ...
    # Prepare QASM input list with URLs
    qasm_input_list = [
    ...
    # Execute function
    merged_circuit, new_intervals = generate_one_circuit_with_two_states(qasm_input_list)
