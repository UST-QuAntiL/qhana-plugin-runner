...
class Schema(FrontendFormBaseSchema):
    ...
    vectors = SetOfTwoComplexVectorsField(
        required=False,
        metadata={
            "label": "Input Vectors",
            "description": (
                "A pair of complex vectors represented as nested lists. "
    ...
    tolerance = ToleranceField(
        ...
        metadata={
            ...
            "description": (
                "Defines the threshold for the inner product when determining orthogonality. "
                "If omitted, the default value is 1e-10."
            ),
            "input_type": "text",
        },
    )
    ...
    def validate_data(self, data, **kwargs):
        """
        Ensures that either 'vectors' or 'qasmInputList' is provided, not both.
        Resets unused fields for consistency.
        """
