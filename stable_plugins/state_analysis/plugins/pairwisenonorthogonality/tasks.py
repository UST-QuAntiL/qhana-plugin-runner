...
from common.algorithms import are_vectors_pairwise_orthogonal
...
_taskname_ = "pairwise_orthogonality"
...
def task(self, db_id: int) -> str:
    ...
    try:
        ...
        ##
        result = are_vectors_pairwise_orthogonal(np_vectors, tolerance=tolerance)
        ##
        end_time = time.time()
