...
from common.algorithms import are_vectors_orthogonal_partitioning_resistance
...
_taskname_ = "orthogonal_partitioning_resistance"
...
def task(self, db_id: int) -> str:
    ...
    try:
        ...
        ##
        result = are_vectors_orthogonal_partitioning_resistance(
            np_vectors, tolerance=tolerance
        )
        ##
        end_time = time.time()
