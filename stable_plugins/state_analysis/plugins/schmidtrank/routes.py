...
_exampleInputs_ = {
    ...
    "dimHX": 2,
    "dimHR": 2,
    "schmidtBaseTolerance": "1e-10",
}

_description_ = "Schmidtrank plugin UI"
...
_data_output_ = [
    OutputDataMetadata(
        ...
        content_type=["application/json"],
        required=True,
        name="schmidtrank-output.json",
    )
]

_help_text_ = "Provide one vector with dimA, dimB or a circuit descriptor with dimA, dimB. The plugin computes the Schmidt rank."
