...
class SdpMaxCutSolver(MaxCutSolver):
    """
    Instantiates the SdpMaxCutSolver with the graph.
    """
    ...
    """
    Solves the max cut problem using a semi definite
    programming approach and returns the
    ...
    def solve(self):
        ...
        TASK_LOGGER.debug("Start solving maxcut using SDP solver")
