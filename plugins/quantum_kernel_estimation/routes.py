...
This plugin produces the matrix for a quantum kernel. Since this depends on the expected values of the quantum circuit, we can only estimate it and therefore call it Quantum Kernel Estimation.
