...
class TransformerType(enum.Enum):
    ...
    def get_name(transformerType) -> str:
        ...
        if transformerType == TransformerType.linearInverse:
            ...
            logging.error(
                'No name for transformer "' + str(transformerType) + '" specified'
            )
            raise ValueError(
                'No name for transformer "' + str(transformerType) + '" specified'
            )
    ...
    def get_description(transformerType) -> str:
        ...
        if transformerType == TransformerType.linearInverse:
            description += (
                "Transforms similarities into distances using "
            ...
            logging.error(
                'No description for transformer "' + str(transformerType) + '" specified'
            )
            raise ValueError(
                'No description for transformer "' + str(transformerType) + '" specified'
            )
