...
class TDAInputParametersSchema(FrontendFormBaseSchema):
    entity_url = FileUrl(
        required=True,
        allow_none=False,
    ...
    homology_dimension = ma.fields.Integer(
        required=False,
        allow_none=False,
        load_default=1,
        metadata={
            "label": "Homology Dimension",
            "description": "Determines the Homology Dimension. Recommended is 1 due to runtime concerns.",
            "input_type": "number",
        },
    )
