...
#   Dataset
#       number of input nodes (n_input_nodes) here: 2 (x and y coords)
#       classes here = [0,1]
#       Number of training points (N_train)
#       Number of test points (N_test)
#   Number of optimization steps (N_total_iterations)
#   qubit count (n_qubits)
#   Learning rate (step)
#   batch site (batch_size)
#   depth of quantum circuit (q_depth)
...
class QNN(QHAnaPluginBase):
    ...
    def get_requirements(self) -> str:
        # return "numpy~=1.22.2\nmatplotlib~=3.5.1\nPennyLane~=0.7.0\nscikit-learn~=1.0.2"  # TODO? # after specifying here "poetry run flask install"
        # Cannot install scikit-learn~=0.24.2 and scikit-learn~=1.0.2
        # daher
        return "numpy~=1.22.2\nmatplotlib~=3.5.1\nPennyLane~=0.7.0\nscikit-learn~=0.24.2"  # TODO? # after specifying here "poetry run flask install"
        # Cannot install PennyLane~=0.7.0 and pennylane~=0.16
        # Daher
        # return "numpy~=1.22.2\nmatplotlib~=3.5.1\nPennyLane~=0.16\nscikit-learn~=0.24.2"  # TODO? # after specifying here "poetry run flask install"
