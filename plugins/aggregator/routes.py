...
from . import AGGREGATOR_BLP, AttributeAggregator
    ...
    def get(self):
        ...
        return PluginMetadata(
            ...
            entry_point=EntryPoint(
                href=url_for(f"{AGGREGATOR_BLP.name}.CalcView"),
            ...
            tags=AttributeAggregator.instance.tags,
        )


@AGGREGATOR_BLP.route("/ui/")
class MicroFrontend(MethodView):
    """Micro frontend for the attribute distance aggregator plugin."""

    @AGGREGATOR_BLP.html_response(
        HTTPStatus.OK,
        description="Micro frontend of the attribute distance aggregator plugin.",
    )
    ...
    def render(self, data: Mapping, errors: dict, valid: bool):
        ...
        return Response(
            render_template(
                ...
                values=data,
                errors=errors,
                process=url_for(f"{AGGREGATOR_BLP.name}.CalcView"),
            )
        )
