...
def get_services():
    # Transform each service to include the required links property
    services_list = []
    for service in services_store.values():
        service_with_links = {
            **service,  # Include all existing service data
            "links": []  # Add the required links property
        }
        services_list.append(service_with_links)

    # Return the list directly (not wrapped in data/links structure)
