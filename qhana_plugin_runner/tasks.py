...
@CELERY.task(name=f"{_name}.add-step-without-ui", bind=True, ignore_result=True)
def add_step_without_ui(
    self,
    task_log: str,
    db_id: int,
    step_id: str,
    ...
    task_data.progress_unit = prog_unit
    task_data.progress_value = prog_value
    task_data.add_next_step_without_ui(href=href, step_id=step_id)
